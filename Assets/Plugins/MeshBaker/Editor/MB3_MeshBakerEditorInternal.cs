...
namespace DigitalOpus.MB.MBEditor
{
    ...
    public class MB3_MeshBakerEditorInternal
    {
        ...
        private void _SaveMeshAsAsset(MB3_MeshBakerCommon target)
        {
            ...
            string relativePath = MB_BatchPrefabBakerEditorFunctions.ConvertFullPathToProjectRelativePath(path);

            AssetDatabase.CreateAsset(bakedMesh, relativePath);
            AssetDatabase.SaveAssets();
            AssetDatabase.Refresh();
            Mesh meshAsset = AssetDatabase.LoadAssetAtPath<Mesh>(relativePath);
