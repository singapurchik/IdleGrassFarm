...
namespace DigitalOpus.MB.Core
{
    ...
    public interface MBVersionEditorInterface
    {
        ...
        string GetScriptingDefineSymbolsFromTg(BuildTargetGroup tg);
        void SetInspectorLabelWidth(float width);
        void UpdateIfDirtyOrScript(SerializedObject so);
        bool GenerateSecondaryUVSetForUnwrapping(Mesh src, UnwrapParam settings);
    ...
    public class MBVersionEditor
    {
        ...
        public static string GetScriptingDefineSymbolsFromTg(BuildTargetGroup tg)
        {
            if (_MBVersion == null) _MBVersion = _CreateMBVersionConcrete();
            return _MBVersion.GetScriptingDefineSymbolsFromTg(tg);
        }
        ...
        public static bool GenerateSecondaryUVSetForUnwrapping(Mesh src, UnwrapParam settings)
        {
            return GetInstance().GenerateSecondaryUVSetForUnwrapping(src, settings);
        }
